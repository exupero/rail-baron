...
return (function (){
if(cljs.core.truth_((function (){var and__4811__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__11400 = script;
(G__11400["type"] = "text/javascript");

(G__11400["onload"] = onload);

(G__11400["onreadystatechange"] = onload);

return G__11400;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__11401 = script__$1;
(G__11401["src"] = src);

return G__11401;
})():(function (){var G__11402 = script__$1;
goog.dom.setTextContext(G__11402,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4823__auto__ = reload;
...
var path_11403 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_11403];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_11403)].join('')];
} else {
}
