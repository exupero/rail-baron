...
(go
  (let [actions (chan)
        usa-c (fetch #(.parse js/JSON %) "resources/public/data/us.json")
        cities-c (fetch reader/read-string "resources/public/data/cities.edn")
        payoffs-c (fetch reader/read-string "resources/public/data/payoffs.edn")
