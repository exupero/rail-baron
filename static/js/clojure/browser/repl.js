...
return (function (){
if(cljs.core.truth_((function (){var and__4170__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__12233 = script;
(G__12233["type"] = "text/javascript");

(G__12233["onload"] = onload);

(G__12233["onreadystatechange"] = onload);

return G__12233;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__12234 = script__$1;
(G__12234["src"] = src);

return G__12234;
})():(function (){var G__12235 = script__$1;
goog.dom.setTextContext(G__12235,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4182__auto__ = reload;
...
var path_12236 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_12236];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_12236)].join('')];
} else {
}
